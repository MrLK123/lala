...
//             data=data.columns.map((item,indxe)=>{
//                   let {title}=item
//                   if(!title){
//                       return ;
//                   }
...
//                       if(title.indexOf("时间") != -1 && title.indexOf("持续时间") == -1){
//                           item.width=132;
//                       }else if(title.indexOf("图片") != -1){
//                           item.width=86;
//                       }else if(title.indexOf("权限") != -1 || title.indexOf("负责城市") != -1){
//                           item.width="40%";
//                           item.className="text-left";
//                       }else{
//                           if(name_list[title]){
//                               item.width=name_list[title];
//                           }
//                       }
//                   }
//                   return item;
...
//            case false:;
//            case null:row_selection = false;break;
//            case "checkbox":rowSelection.type="checkbox";break;
//            default:row_selection=true;  
